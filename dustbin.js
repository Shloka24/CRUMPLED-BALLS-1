class Dustbin {
    constructor(x, y){
        ...
        this.leftWall = Bodies.rectangle(x-100, y-40, this.wallThickness, this.height, options);
         Matter.Body.setAngle(this.leftWall, this.angle);

        this.rightWall = Bodies.rectangle(x+100, y-40,this.wallThickness, this.height, options);
